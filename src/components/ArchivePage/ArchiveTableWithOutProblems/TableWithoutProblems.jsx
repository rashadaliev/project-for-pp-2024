...
import styles from "../ArchiveTableWithOutProblems/TableWithoutProblems.module.css";

const TableWithoutProblems = ({ orders }) => {
  return (
    <>
      <table
        style={{
...
export default TableWithoutProblems;
