...
const WhiteBusinessTemplate = () => {
  ...
  const [info, setInfo] = useState({
    title: "Заголовок",
    description:
      "Наш магазин продаёт товары только из качесвтенных переработанных материалов. Мы уважаем природу и стремимся поменять мир к лучшему, поэтому 5% с каждой продажи идут в фонд помощи.",
  });
